...
# 2 "<built-in>" 2
# 1 "source/temperatureSensor.c" 2
...
# 9 "source/temperatureSensor.c" 2
...
# 10 "source/temperatureSensor.c" 2
...
# 11 "source/temperatureSensor.c" 2
...
# 14 "source/temperatureSensor.c" 2

# 1 "../mylib/include\\temperatureSensor.h" 1
# 19 "../mylib/include\\temperatureSensor.h"
typedef struct{
    double A,B,C;
    unsigned char Vin;
    unsigned int R1;
...
# 15 "source/temperatureSensor.c" 2
# 29 "source/temperatureSensor.c"
...
ThermistorData_t thermistor;
# 55 "source/temperatureSensor.c"
void ADC_setup(){
...
const char Ohm2C(unsigned const x){
    ...
    return 1.0f/(
            thermistor.A +
            thermistor.B*logR +
            thermistor.C*logR*logR*logR)- 273.15
            ;
}


char* update_ADC_results(){
    double Vout=5/1024.0f * ADC_results.all;
    unsigned Rt=2500*Vout/(5 -Vout);
...
__attribute__((inline)) void ADC_Read(){
    ADC_results.LOW=ADRESL;
    ADC_results.HIGH=ADRESH;
    ADC_results.isUpdated=0;
}
...
void sensorRead_ISR(){
    extern void counting_ISR();
    extern unsigned count_sec;
    ...
    if( count_sec_OLD!=count_sec && ADIF==1){
        count_sec_OLD=count_sec; ADIF=0;
        ADC_Read();
        ADCON0bits.GO=1;
    }
}
...
void setupTemperatureSensor(){
    ...
    ADCON0bits.ADON=1; _delay((unsigned long)((3)*(8000000/4000000.0)));
    ADCON0bits.GO=1;
}
